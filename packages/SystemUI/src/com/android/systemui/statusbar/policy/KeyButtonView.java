...
public class KeyButtonView extends ImageView {
        ...
        public void run() {
            ...
            if (isPressed()) {
                ...
                if (mLongpressAction != null
                    && TGActions.isActionKeyEvent(mLongpressAction)) {
                    ...
                    if (mCode != 0) {
                        ...
                        if (doIt) {
                            if (mClickAction != null
                                && !TGActions.isActionKeyEvent(mClickAction)) {
    ...
    private OnClickListener mClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            TGActions.processAction(mContext, mClickAction, false);
            return;
        }
    };
    ...
    private OnLongClickListener mLongPressListener = new OnLongClickListener() {
        ...
        public boolean onLongClick(View v) {
            TGActions.processAction(mContext, mLongpressAction, true);
            return true;
        }
    };
