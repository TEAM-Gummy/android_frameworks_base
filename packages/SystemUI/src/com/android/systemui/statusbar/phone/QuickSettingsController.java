...
import static com.android.internal.util.gummy.QSConstants.TILES_DEFAULT;
import static com.android.internal.util.gummy.QSConstants.DYNAMIC_TILES_DEFAULT;
import static com.android.internal.util.gummy.QSConstants.TILE_AIRPLANE;
import static com.android.internal.util.gummy.QSConstants.TILE_ALARM;
import static com.android.internal.util.gummy.QSConstants.TILE_AUTOROTATE;
import static com.android.internal.util.gummy.QSConstants.TILE_BATTERY;
...
import static com.android.internal.util.gummy.QSConstants.TILE_CUSTOM_KEY;
...
import static com.android.internal.util.gummy.QSConstants.TILE_QUICKRECORD;
import static com.android.internal.util.gummy.QSConstants.TILE_QUIETHOURS;
import static com.android.internal.util.gummy.QSConstants.TILE_RINGER;
import static com.android.internal.util.gummy.QSConstants.TILE_SCREENTIMEOUT;
import static com.android.internal.util.gummy.QSConstants.TILE_SETTINGS;
import static com.android.internal.util.gummy.QSConstants.TILE_SLEEP;
import static com.android.internal.util.gummy.QSConstants.TILE_SYNC;
import static com.android.internal.util.gummy.QSConstants.TILE_TORCH;
import static com.android.internal.util.gummy.QSConstants.TILE_USBTETHER;
import static com.android.internal.util.gummy.QSConstants.TILE_USER;
import static com.android.internal.util.gummy.QSConstants.TILE_VOLUME;
import static com.android.internal.util.gummy.QSConstants.TILE_WIFI;
import static com.android.internal.util.gummy.QSConstants.TILE_WIFIAP;
...
import com.android.systemui.quicksettings.DarkGummyTile;
...
public class QuickSettingsController {
    ...
    void loadTiles() {
        ...
        for (String tile : tiles.split("\\|")) {
            ...
            } else if (tile.equals(TILE_PERFORMANCEPROFILE)) {
                if (DeviceUtils.deviceSupportsPerformanceProfiles(mContext)) {
            ...
            } else if (tile.equals(TILE_DARKGUMMY)) {
                qs = new DarkGummyTile(mContext, this);
